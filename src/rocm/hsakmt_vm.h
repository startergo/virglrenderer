...
#define MAX_SCRATCH_APERTURE_PER_XCC (1ULL << 32)

#define VIRTGPU_HSAKMT_CONTEXT_AMDGPU      1
#define VHSA_VAMGR_VM_TYPE_FIXED_BASE      1
#define VHSA_VAMGR_VM_TYPE_NEGOTIATED      2
#define VHSA_FIXED_VM_BASE_ADDR            0x100000000000UL
#define VHSA_CTX_RESERVE_SIZE              (64UL * VHSA_1G_SIZE)
#define VHSA_VAMGR_VM_MAX_KFD_SIZE         (8UL * 1024 * VHSA_1G_SIZE)
#define VHSA_CTX_SCRATCH_SIZE              (1ULL << 32)
#define VHSA_SCRATCH_RESERVE_SIZE          (VHSA_MAX_CTX_SIZE * VHSA_CTX_SCRATCH_SIZE)
...
int vhsakmt_dereserve_va(uint64_t start, uint64_t size);
