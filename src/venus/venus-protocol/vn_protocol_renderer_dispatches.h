...
static void (*const vn_dispatch_table[344])(struct vn_dispatch_context *ctx, VkCommandFlagsEXT flags) = {
    ...
    [VK_COMMAND_TYPE_vkWriteSamplerDescriptorsEXT_EXT] = vn_dispatch_vkWriteSamplerDescriptorsEXT,
    [VK_COMMAND_TYPE_vkWriteResourceDescriptorsEXT_EXT] = vn_dispatch_vkWriteResourceDescriptorsEXT,
...
static inline void vn_dispatch_command(struct vn_dispatch_context *ctx)
{
    ...
    {
        if (cmd_type < 344 && vn_dispatch_table[cmd_type])
